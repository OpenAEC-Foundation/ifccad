...
pub use entity::{BlockInstanceRef, EntityIterator, IfcdrEntityRef};
pub use resource::{BlockDefinitionRef, IfcdrResourceRef, ModelSpaceRef, PaperSpaceRef, ScopeRef};
