# IFCDR 0.9.0 logical contract

This document, [the logical registry](registry-0.9.0.json), and the applicable
encoding mapping define the IFCDR 0.9.0 contract. The
[JSON reference mapping](json-mapping-0.9.0.json) specifies physical storage.
...
The [JSON mapping language v3](json-mapping-v3.md) defines payload locations,
omission, nulls, value mappings, point pools, child ranges and directory rules.
The [0.9.0 mapping](json-mapping-0.9.0.json) applies those forms to this
