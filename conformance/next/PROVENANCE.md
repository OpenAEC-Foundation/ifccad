...
- Included schemas: IFCX overlay `0.8.0`, drawing core `0.2.0`, IFCDR logical registry and normative contract `0.7.0`, registry meta-schema v2, JSON mapping `0.7.0` with meta-schema v1, and IFCPR `0.2.0`
